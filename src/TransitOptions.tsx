...
export function TransitOptions({from,to,onModels,onJourney,autoRun,onAutoRunDone,tourFor,walkPaths}:{from:CityPlace|null;to:CityPlace|null;onModels:(id:PilotAssetId)=>void;onJourney:(journey:TransitSimulation|null)=>void;autoRun?:number;onAutoRunDone?:()=>void;tourFor?:(place:CityPlace|null)=>TourPlace|null;walkPaths?:(legs:{from:Coordinate;to:Coordinate}[])=>Promise<(Coordinate[]|null)[]|null>}){
